...
/* Bettet alle presets/**\/*.md (außer README.md) als inaktive
   <script type="text/plain">-Blöcke in beide Modul-HTML-Dateien ein.
   ...
   und alles (presets/ + beide HTML-Dateien) committen. */
'use strict';
const fs = require('fs');
...
for (const htmlFile of HTML_FILES) {
  ...
  console.log(path.relative(__dirname, htmlFile) + ': ' + files.length + ' Preset-Dateien eingebettet (' + kb + ' KB)');
}
